...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    loadHeatmap();
  }, [language, instanceKey]);

  // Fetch active weekly book
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="beta-badge-banner">
        <span className="badge-text">🚀 Beta Testing — VaagaTypePanalam v0.8</span>
